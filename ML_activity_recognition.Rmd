---
title: "Practical ML Activity recognition"
...
For \*classe\_\_A\* it seems that the "Arm and Forearm" sensors are more important.
...
-   So top 5 significant features for "classe\_\_A" are - (magnet_arm_x, pitch_forearm , magnet_dumbbell_y, roll_forearm, gyros_dumbbell_y)
...
For \*classe\_\_B\* it seems that the "Dumbbell and Belt" sensors are more important.
...
-   So top 5 significant features for "classe\_\_A" are - (magnet_dumbbell_y, magnet_dumbbell_x , roll_dumbbell , magnet_belt_y , accel_dumbbell_x )
...
For \*classe\_\_C\* it seems that the "Dumbbell" sensors are more important.
...
-   So top 5 significant features for "classe\_\_A" are - (magnet_dumbbell_y, roll_dumbbell , accel_dumbbell_y , magnet_dumbbell_x, magnet_dumbbell_z)
...
For \*classe\_\_D\* it seems that the "Forearm, Arm and Dumbbell" sensors are more important.
...
-   So top 5 significant features for "classe\_\_A" are - (pitch_forearm , magnet_arm_y , magnet_forearm_x, accel_dumbbell_y, accel_forearm_x)
...
For \*classe\_\_E\* it seems that the "Belt" sensors are more important.
...
-   So top 5 significant features for "classe\_\_A" are - (magnet_belt_y , magnet_belt_z , roll_belt, gyros_belt_z , magnet_dumbbell_y)
